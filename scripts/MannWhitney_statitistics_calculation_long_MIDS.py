...
with open (table, "r") as analysis_file:
    ...
    CLV=analysis_table[(analysis_table.ELMType == 'CLV')].Long_MIDS_per_instance.values.tolist()
    DEG=analysis_table[(analysis_table.ELMType == 'DEG')].Long_MIDS_per_instance.values.tolist()
    DOC=analysis_table[(analysis_table.ELMType == 'DOC')].Long_MIDS_per_instance.values.tolist()
    LIG=analysis_table[(analysis_table.ELMType == 'LIG')].Long_MIDS_per_instance.values.tolist()
    MOD=analysis_table[(analysis_table.ELMType == 'MOD')].Long_MIDS_per_instance.values.tolist()
    TRG=analysis_table[(analysis_table.ELMType == 'TRG')].Long_MIDS_per_instance.values.tolist()
    
    
    
    CLV_euk= analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    #print(CLV_euk)

    CLV_bac=analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'bacteria')].Long_MIDS_per_instance.values.tolist()
    CLV_virus=analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    DEG_euk= analysis_table[(analysis_table.ELMType == 'DEG') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    DEG_virus=analysis_table[(analysis_table.ELMType == 'DEG') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    DOC_euk= analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    DOC_bac= analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'bacteria')].Long_MIDS_per_instance.values.tolist()
    DOC_virus=analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    LIG_euk= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    LIG_bac= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'bacteria')].Long_MIDS_per_instance.values.tolist()
    LIG_virus= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    MOD_euk= analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    MOD_bac= analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'bacteria')].Long_MIDS_per_instance.values.tolist()
    MOD_virus=analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    TRG_euk=analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'eukaryotes')].Long_MIDS_per_instance.values.tolist()
    TRG_bac= analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'bacteria')].Long_MIDS_per_instance.values.tolist()
    TRG_virus= analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'viruses')].Long_MIDS_per_instance.values.tolist()
    
    
    #calculate Mann-Whitney statistics
    print('Long disorder IUPRED 2A MIDS comparison by ELM type between taxonomic groups') 
    ...
    print('\n Long disorder IUPRED 2A MIDS Virus analysis') 
    ##Virus analysis
    ...
    print('\n Long disorder IUPRED 2A MIDS Eukaryotes analysis')    
    ##euk analysis
    ...
    print('\n Long disorder IUPRED 2A MIDS Bacteria analysis')        
    ##bac analysis
...
################ All groups by ELM type ###########################
    print('\n Long disorder IUPRED 2A MIDS all analysis')  
