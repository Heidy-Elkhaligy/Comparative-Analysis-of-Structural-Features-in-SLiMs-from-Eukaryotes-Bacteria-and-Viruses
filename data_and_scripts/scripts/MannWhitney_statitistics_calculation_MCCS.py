...
with open (table, "r") as analysis_file:
    ...
    CLV=analysis_table[(analysis_table.ELMType == 'CLV')].MCCS_per_instance.values.tolist()
    DEG=analysis_table[(analysis_table.ELMType == 'DEG')].MCCS_per_instance.values.tolist()
    DOC=analysis_table[(analysis_table.ELMType == 'DOC')].MCCS_per_instance.values.tolist()
    LIG=analysis_table[(analysis_table.ELMType == 'LIG')].MCCS_per_instance.values.tolist()
    MOD=analysis_table[(analysis_table.ELMType == 'MOD')].MCCS_per_instance.values.tolist()
    TRG=analysis_table[(analysis_table.ELMType == 'TRG')].MCCS_per_instance.values.tolist()
    
    
    
    CLV_euk= analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    #print(CLV_euk)

    CLV_bac=analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'bacteria')].MCCS_per_instance.values.tolist()
    CLV_virus=analysis_table[(analysis_table.ELMType == 'CLV') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    DEG_euk= analysis_table[(analysis_table.ELMType == 'DEG') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    DEG_virus=analysis_table[(analysis_table.ELMType == 'DEG') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    DOC_euk= analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    DOC_bac= analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'bacteria')].MCCS_per_instance.values.tolist()
    DOC_virus=analysis_table[(analysis_table.ELMType == 'DOC') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    LIG_euk= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    LIG_bac= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'bacteria')].MCCS_per_instance.values.tolist()
    LIG_virus= analysis_table[(analysis_table.ELMType == 'LIG') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    MOD_euk= analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    MOD_bac= analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'bacteria')].MCCS_per_instance.values.tolist()
    MOD_virus=analysis_table[(analysis_table.ELMType == 'MOD') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    TRG_euk=analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'eukaryotes')].MCCS_per_instance.values.tolist()
    TRG_bac= analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'bacteria')].MCCS_per_instance.values.tolist()
    TRG_virus= analysis_table[(analysis_table.ELMType == 'TRG') & (analysis_table.Taxonomic_group == 'viruses')].MCCS_per_instance.values.tolist()
    
    
    #calculate Mann-Whitney statistics
    print('MCCS comparison by ELM type between taxonomic groups')
