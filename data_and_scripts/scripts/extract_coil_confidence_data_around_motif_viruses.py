            ...
            if int(adjusted_start) == 1:
                ...
                if protein_id == elm_protein_id and orig_start in list(range(int(adjusted_start),int(adjusted_end))):
                 ...
                 if protein_id == elm_protein_id and orig_start in list(range(int(adjusted_start),int(adjusted_end))):
                    ...
                    elm_seq_end= orig_end -int(adjusted_start)+2
                    
                    if elm_seq_start - RANGE <= 0:
                        coil_conf = coil_conf_list[0:elm_seq_start-1]
                        #print(orig_start)
                        #print(coil_conf)
                        #print(len(coil_conf))
                        remaining_data_num=RANGE-len(coil_conf)
                        ...
                        coil_conf=coil_conf_list[elm_seq_start-(RANGE+1):elm_seq_start-1]
                        #print(orig_start)
                        #print(len(coil_conf))
                        #print(coil_conf)
                        before_motif.append([elm_accession, elm_type, elm_identifier, elm_protein_name, elm_protein_id, orig_start, orig_end, elm_mean, coil_conf])
                        
                    if len(coil_conf_list) - elm_seq_end - RANGE <= 0:
                        
                        coil_conf= coil_conf_list[elm_seq_end:len(coil_conf_list)+1]
                        #print(coil_conf)
                        #print(orig_end)
                        #print(len(coil_conf))
                        remaining_data_num=RANGE-len(coil_conf)
                        ...
                        coil_conf_data_after=coil_conf_list[elm_seq_end:elm_seq_end+RANGE]
                        after_motif.append([elm_accession, elm_type, elm_identifier, elm_protein_name, elm_protein_id, orig_start, orig_end, elm_mean, coil_conf_data_after])
